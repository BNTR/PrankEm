...
//  PrankMe
//
//  Created by VIktor Sokolov on 11.09.14.
...
@property (nonatomic, strong) IBOutlet UIImageView *rotateImage;
@property (nonatomic, strong) IBOutlet UIImageView *sizeImagw;
